...
<table>
  ...
  <tbody align="left">
    <tr>
      ...
      <td align="center">
        <a href="https://link-do-material.com">
...
2. Clone localmente: `git clone https://github.com/SEU_USERNAME/dio-lab-open-source.git`;
   >Clone seu fork do repositório, substituindo SEU_USERNAME pelo seu nome de usuário do GitHub./**/
4. Adicione o remote upstream para manter seu repositório local atualizado. Por exemplo: `git remote add upstream https://github.com/digitalinnovationone/dio-lab-open-source.git`;
    >Esse comando adiciona o repositório original como remoto (chamado de upstream), o que permitirá manter o seu fork atualizado com as últimas alterações feitas no repositório original./**/
...
10. Envie suas alterações para o seu repositório remoto com o comando: `git push origin feat/community/SEU_USERNAME`; /**/
